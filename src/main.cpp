...
static const int64 nTargetTimespan = 7 * 24 * 60 * 60; // Testcoin: 7 days
...
bool InitBlockIndex() {
	...
	if (true && block.GetHash() != hashGenesisBlock)
	{
		...
		//This will figure out a valid hash and Nonce if your're 
		...
		loop
		{
			...
			//it is faster to use directly than to use a fucntion piointer or conditional.
#if deinfed(_M_X64) || defined(_x86_64__) || defined(_M_AMD64) || (defined(MAC_OSX) && defined(__i386__))
			//alsways SSE2:  x86_64 or  Intel MacOS X
			...
			if (block.nNonce == 0)
			{
				printf("NONCE WARPPED, incrementing time\n");
				++block.nTime;
			}
		}
	...
	/** CHOI_DEBUG: end Inserted  codesnippet:  pastebin.com/jDMPUNuP#  */
